...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/cataluna.css') }}">
    <!-- Boxicons CDN Link -->
...
<body>
    ...
    <div class="sidebar">
        <div class="logo-details">
            <div class="logo_name" onclick="location.href='/lubeck'" style="cursor: pointer"><i class='bx bx-left-arrow-alt'></i>ir a Lubeck</div>
            <i class='bx bx-menu' id="btn"></i>
        </div>
        <ul class="nav-list" style="height: 370px">
            <li>
                <a href="{{ asset('cataluna') }}" title="Inicio">
                    <i class='bx bx-home'></i>
                    <span class="links_name">Home Cataluña</span>
                </a>
                <span class="tooltip">Home Cataluña</span>
            </li>
            <li>
                <a href="{{ asset('cataluna/buscador') }}" title="Buscador convenio ferretería">
            ...
            <li>
                <a href="{{ asset('cataluna/stock') }}" title="Productos con stock">
            ...
            <li>
                <a href="{{ asset('cataluna/sin_stock') }}" title="Productos sin stock">
            ...
            <li>
                <a href="{{ asset('cataluna/stock_dispersion') }}" title="Productos con stock fuera de despersión">
            ...
            <li>
                <a href="{{ asset('cataluna/sin_stock_dispersion') }}" title="Productos sin stock fuera de despersión">
            ...
            <li>
                <a href="{{ asset('cataluna/ofertas') }}" title="Productos en oferta">
            ...
            <li>
                <a href="{{ asset('cataluna/mas-buscados') }}" title="Terminos mas buscados">
            ...
            <li>
                <a href="{{ asset('cataluna/mas-visitas') }}" title="Producto con mas visitas">
