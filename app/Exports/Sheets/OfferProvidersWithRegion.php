...
class OfferProvidersWithRegion implements FromView, WithTitle, ShouldAutoSize, WithStyles
{
    private $provider;
    private $count;
    private $wide;
    ...
    public function __construct($provider, $convenio, $region){
    ...
    public function view(): View
    {
        ...
        ])->where('convenio', $this->convenio)->join('product_providers', function($query) use ($provider, $region){
